...
const KPICard = ({ title, value, growth, icon: Icon, isCurrency = false }: any) => (
  <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.02)] flex-1 group hover:border-blue-100 transition-all duration-500">
    ...
    <p className="text-[11px] font-bold text-gray-400 mt-3 flex items-center gap-1.5">
       <Clock className="w-3 h-3" /> vs previous period
    </p>
  </div>
);
...
export default function ReportsPage() {
  ...
  const exportExcel = () => {
    ...
    XLSX.writeFile(wb, `Report_Sales_${new Date().toISOString().split('T')[0]}.xlsx`);
  };
  ...
  const exportPDF = async () => {
    ...
    pdf.save(`Report_Sales_${new Date().toISOString().split('T')[0]}.pdf`);
  };
    ...
    return (
      <div className="flex h-screen bg-[#F9FAFB] items-center justify-center">
        <div className="flex flex-col items-center gap-4">
           ...
           <p className="text-sm font-black text-gray-900 uppercase tracking-widest">Aggregating Global Metrics...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="flex h-screen bg-[#F9FAFB] overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col ml-64 w-[calc(100%-256px)] overflow-y-auto" ref={reportRef}>
        ...
        <header className="px-12 pt-10 pb-6 bg-transparent flex items-start justify-between">
          <div>
            <h1 className="text-4xl font-black text-gray-900 tracking-tight mb-2">Sales Reports</h1>
            <p className="text-base text-gray-500 font-medium tracking-tight">Real-time analytical workspace for Store #402</p>
          </div>
        ...
        <div className="px-12 pb-8 flex items-center gap-4 sticky top-0 bg-[#F9FAFB] z-20 pt-2">
           <div className="flex-1 flex gap-4">
              <div className="flex-1 bg-white rounded-2xl border border-gray-100 px-5 py-2 group focus-within:border-blue-200 transition-all">
                 <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-0.5">Date Range</p>
              ...
              <div className="flex-1 bg-white rounded-2xl border border-gray-100 px-5 py-2 group focus-within:border-blue-200 transition-all">
                 <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-0.5">Report Type</p>
                 <div className="flex items-center justify-between">
                    <select 
                       value={filters.type}
              ...
              <div className="w-[300px] flex items-center bg-gray-100 px-5 rounded-2xl">
                 ...
                 <input className="bg-transparent border-none focus:ring-0 text-sm font-bold text-gray-600 w-full" placeholder="Search parameters..." />
              </div>
           </div>
        </div>
        ...
        <main className="flex-1 px-12 pb-12 space-y-8">
          ...
          {isEmpty ? (
             <div className="flex flex-col items-center justify-center py-20 animate-in fade-in slide-in-from-bottom-4">
                ...
                <h2 className="text-3xl font-black text-gray-900 tracking-tight mb-2">No data available for this period</h2>
                <p className="text-gray-500 font-medium mb-10 max-w-md text-center">Try adjusting your filters or date range to see results from active store operations.</p>
            ...
            <>
              ...
              <div className="grid grid-cols-12 gap-8">
                <div className="col-span-8 bg-white p-10 rounded-[48px] border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.02)]">
                  <div className="flex items-center justify-between mb-8">
                     <div>
                        ...
                        <p className="text-sm font-medium text-gray-400">Daily revenue trends over the selected period</p>
                     </div>
                     <div className="flex bg-gray-50 p-1.5 rounded-2xl gap-1">
                        <button className="px-5 py-2 bg-white text-blue-600 rounded-xl text-xs font-black shadow-sm">Revenue</button>
                        <button className="px-5 py-2 text-gray-400 rounded-xl text-xs font-black hover:text-gray-900 transition-all">Volume</button>
                     </div>
                  </div>
                ...
                <div className="col-span-4 bg-white p-10 rounded-[48px] border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.02)] flex flex-col">
                  <h3 className="text-xl font-black text-gray-900 tracking-tight mb-8">Revenue Distribution</h3>
                  <div className="flex-1 min-h-[300px] relative flex items-center justify-center">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                       ...
                       <p className="text-[9px] font-black text-gray-400 tracking-widest uppercase mt-1">Total Share</p>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-12 gap-8">
                 <div className="col-span-5 bg-white p-10 rounded-[48px] border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.02)] flex flex-col">
                    <div className="flex items-center justify-between mb-10">
                       ...
                       <button className="text-[10px] font-black text-blue-600 hover:text-blue-800 uppercase tracking-widest decoration-2 underline underline-offset-4 transition-all">View inventory details</button>
                    </div>
                 ...
                 <div className="col-span-7 bg-white p-10 rounded-[48px] border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.02)]">
                    <div className="flex items-center justify-between mb-8">
                       <h3 className="text-xl font-black text-gray-900 tracking-tight">Recent High-Value Transactions</h3>
