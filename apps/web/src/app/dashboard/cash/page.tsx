  ...
  return (
    <div className="flex h-screen bg-[#F8F9FC] overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col lg:ml-64 overflow-hidden transition-all duration-300">
        ...
        {/* Module Header */}
        <div className="px-4 lg:px-10 py-6 lg:py-8 bg-transparent flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 shrink-0">
          <div>
            <h1 className="text-2xl lg:text-4xl font-black text-gray-900 tracking-tight leading-none mb-2">Caja</h1>
            <p className="text-sm lg:text-base text-gray-400 font-medium">Control de flujos de efectivo.</p>
          </div>
          <div className="flex items-center gap-3 w-full sm:w-auto">
             ...
             {!register ? (
                <button 
                    ...
                    className="flex-1 sm:flex-none bg-emerald-600 hover:bg-emerald-700 text-white px-6 lg:px-8 py-4 rounded-2xl font-black text-xs lg:text-sm transition-all shadow-xl shadow-emerald-100 flex items-center justify-center gap-3"
                >
                    <Unlock className="w-5 h-5" /> Apertura
                </button>
             ) : (
                <button 
                    onClick={() => setIsCloseModalOpen(true)}
                    className="flex-1 sm:flex-none bg-blue-600 hover:bg-blue-700 text-white px-6 lg:px-8 py-4 rounded-2xl font-black text-xs lg:text-sm transition-all shadow-xl shadow-blue-100 flex items-center justify-center gap-3"
                >
                    <Lock className="w-5 h-5" /> Cerrar
                </button>
             )}
          </div>
        </div>

        <main className="flex-1 overflow-y-auto px-4 lg:px-10 py-4 lg:py-10 space-y-8 lg:space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <StatCard 
              ...
              subtitle={register ? `Inicio: ${fmtTime(register.createdAt)}` : 'Cerrada'}
          ...
          <section className="bg-white rounded-[40px] shadow-sm border border-gray-100 overflow-hidden flex flex-col">
            <div className="px-6 lg:px-10 py-6 lg:py-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 border-b border-gray-50 bg-white sticky top-0 z-10">
              <div className="flex items-center gap-4">
                 <h2 className="text-lg lg:text-xl font-black text-gray-900">Bitácora</h2>
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                 <button 
                    ...
                    disabled={!register}
                    className="flex-1 sm:flex-none px-6 py-3 bg-gray-50 text-gray-600 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-gray-100 transition-all flex items-center justify-center gap-2 disabled:opacity-30"
                 >
