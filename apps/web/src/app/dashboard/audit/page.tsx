          ...
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-1">
                <nav className="flex items-center gap-2 text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] mb-2">
                  ...
                  <span>/</span>
                  <span className="text-gray-400">Auditoría de Logs</span>
                </nav>
                <h1 className="text-4xl font-black text-gray-900 tracking-tighter leading-none">Bitácora Global</h1>
                <p className="text-sm font-medium text-gray-500 mt-2">Monitoreo inalterable de cada interacción con el núcleo del sistema.</p>
              </div>
              ...
              <div className="flex items-center gap-3">
                 <div className="bg-white px-5 py-3 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black text-gray-900 uppercase tracking-widest">Servicio de Auditoría Activo</span>
                 </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-[32px] border border-gray-100 shadow-sm flex flex-wrap items-center gap-4">
               <div className="flex-1 min-w-[280px] relative group">
                  ...
                  <input 
                    type="text"
                    placeholder="Filtrar por descripción, evento o usuario..."
                    value={search}
               ...
               <div className="flex items-center gap-2 bg-gray-50 p-1 rounded-2xl">
                 <select 
                   ...
                   className="bg-transparent px-4 py-2.5 text-xs font-black text-gray-600 uppercase tracking-wider outline-none cursor-pointer"
                 >
                 ...
                 <div className="flex items-center gap-2 px-3 py-2 text-xs font-black text-gray-400">
